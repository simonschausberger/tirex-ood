...
# chronos ID data
CHRONOS_TRAIN = [
    "monash_pedestrian_counts", "wind_farms_hourly", "wiki_daily_100k", "monash_rideshare", 
    ...
    "electricity_15_min", "monash_electricity_hourly", "monash_electricity_weekly", 
...
CHRONOS_ZS_BENCHMARK = [
    ...
    "mmonash_3_monthly", "monash_m3_yearly", "monash_m3_quarterly"
]
...
GIFTEVAL_TRAIN = [
    ...
    "azure_vm_traces_2017", "borg_cluster_data_2011", "bdg_2_panther", "bdg_2_fox", 
    "bdg_2_rat", "bdg_2_bear", "lcl",  "sceaux", "borealis", "buildings_900k", 
    "largest_2017", "largest_2018", "largest_2019", "largest_2020",
    "largest_2021", "pems03", "pems04", "pems07", "pems08", "pems_bay", "los_loop",
    "beijing_subway_30min", "shmetro", "hzmetro", "q_traffic", "subseasonal",
    "subseasonal_precip", "wind_power", "solar_power", "kaggle_web_traffic_weekly",
    "kdd_2022", "godaddy", "favorita_sales", "china_air_quality", "beijing_air_quality",
    "cdc_fluview_ilinet", "cdc_fluview_who"
]
...
GIFTEVAL_ZS_BENCHMARK = [
    ...
    "bizitobs_12c", "bizitobs_service", "car_parts", "covid_deaths", "elictricity/D", 
    "ett2", "hierarchical_sales", "hospital",  "loop_seattle", "m4_quarterly",
    "m4_yearly", "m_dense", "restaurant", "saugeen", "solar", "sz_taxi", "us_births"
]